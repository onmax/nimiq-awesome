...
- [Nimiq Hub](https://hub.nimiq.com/) ([Source](https://github.com/nimiq/hub)) ([@Nimiq](https://github.com/onmax)): Unified interface for accounts, addresses, and contracts
- [Nimiq Keyguard](https://keyguard.nimiq.com/) ([Source](https://github.com/nimiq/keyguard)) ([@Nimiq](https://github.com/onmax)): Secure key management and transaction signing
- [Nimiq Demo Project](https://github.com/nimiq/nimiq-demo) ([Source](https://github.com/nimiq/nimiq-demo)) ([@Nimiq](https://github.com/onmax)): Simple project demonstrating wallet and transaction functions
...
- [Nimiq Cashlink Bulk Generator](https://github.com/nimiq/cashlink-generator) ([Source](https://github.com/nimiq/cashlink-generator/tree/master)) ([@Nimiq](https://github.com/onmax)): Tool to create and manage NIM cashlinks in bulk

### Documentation

- [Nimiq Developer Center](https://nimiq.com/developers/) ([Source](https://github.com/nimiq/developer-center)) ([@Nimiq](https://github.com/onmax)): Official guide with tutorials and technical references
- [NimiqHub RPC Docs](https://www.nimiqhub.com/docs/rpc) ([@DovAzencot](https://github.com/onmax)): Documentation for the Nimiq JSON-RPC interface

### Core

- [Nimiq Core Rust](https://github.com/nimiq/core-rs-albatross) ([Source](https://github.com/nimiq/core-rs-albatross)) ([@Nimiq](https://github.com/onmax)): Rust implementation of Nimiq consensus (Albatross/PoS)
- [Nimiq Gleam](https://github.com/sisou/nimiq_gleam) ([Source](https://github.com/sisou/nimiq_gleam)) ([@sisou](https://github.com/onmax)): Modules and helpers for Nimiq in Gleam
- [Nim Log](https://nimlog.paberr.net/history.html) ([@paberr](https://github.com/onmax)): Explorer for Nimiq blockchain logs and transactions

### Rpc

- [Open RPC server](https://rpc.nimiqwatch.com/) ([@sisou](https://github.com/onmax)): A public JSON-RPC server to make initial developments easier
- [Nimiq JSON-RPC Client for Gleam](https://github.com/sisou/gleam-nimiq-rpc) ([Source](https://github.com/sisou/gleam-nimiq-rpc)) ([@sisou](https://github.com/onmax)): Gleam library for Nimiq JSON-RPC interaction
...
- [Nimiq RPC Client for TS](https://jsr.io/@blouflash/nimiq-rpc) ([Source](https://jsr.io/@blouflash/nimiq-rpc)) ([@blouflash](https://github.com/onmax)): JSON-RPC client for Nimiq blockchain

### Ui

- [Nimiq Style Framework](https://nimiq.github.io/nimiq-style/) ([@Nimiq](https://github.com/onmax)): Official CSS framework with Nimiq colors and fonts
...
- [Nimiq Identicons](https://github.com/nimiq/identicons) ([Source](https://github.com/nimiq/identicons)) ([@Nimiq](https://github.com/onmax)): JS library for generating identicons from Nimiq addresses
...
- [Nimiq Utils](https://github.com/nimiq/nimiq-utils) ([Source](https://github.com/nimiq/nimiq-utils)) ([@Nimiq](https://github.com/onmax)): Collection of JS utilities for Nimiq
- [Nimiq Nuxt Module](https://github.com/blouflashdb/nimiq-nuxt-module) ([Source](https://github.com/blouflashdb/nimiq-nuxt-module)) ([@blouflashdb](https://github.com/onmax)): Nuxt 3 module for integrating a Nimiq client in Vue apps

### Validator

- [Validators Dashboard & API](https://validators-api-mainnet.nuxt.dev/) ([Source](https://github.com/nimiq/validators-api)) ([@Nimiq](https://github.com/onmax)): Dashboard and API for monitoring validators
- [Telegram Bot for Staking Notifications](https://github.com/Albermonte/validator-election-bot) ([Source](https://github.com/Albermonte/validator-election-bot)) ([@albermonte](https://github.com/onmax)): Sends alerts about validator elections on Telegram

### Node

- [arpl](https://github.com/sisou/arpl) ([Source](https://github.com/sisou/arpl)) ([@sisou](https://github.com/onmax)): CLI tool for remote management of Nimiq nodes
- [Postgres Chain Mirror](https://github.com/sisou/bun-drizzle-chain-mirror) ([Source](https://github.com/sisou/bun-drizzle-chain-mirror)) ([@sisou](https://github.com/onmax)): Mirrors Nimiq blockchain data into a PostgreSQL database

### Infrastructure

- [Nimiq Albatross Node in Docker](https://hub.docker.com/r/maestroi/nimiq-albatross) ([@maestroi](https://github.com/onmax)): Docker image for running a Nimiq full/validator node
